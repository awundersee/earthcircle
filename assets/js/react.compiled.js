...
function App() {
  ...
  const getAriaLabel = (key, label) => {
    if (sortKey === key) {
      return sortAsc ? `${label}, aufsteigend sortiert` : `${label}, absteigend sortiert`;
    }
  ...
  return /*#__PURE__*/React.createElement("table", {
    ...
    scope: "col",
    className: getSortClass("country"),
    "aria-sort": sortKey === "country" ? sortAsc ? "ascending" : "descending" : "none"
    ...
    "aria-sort": sortKey === "company" ? sortAsc ? "ascending" : "descending" : "none"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    "aria-sort": sortKey === "emissions" ? sortAsc ? "ascending" : "descending" : "none"
  }, /*#__PURE__*/React.createElement("button", {
    type: "button",
  ...
  }, row.country), /*#__PURE__*/React.createElement("td", {
    className: sortKey === "company" ? "is-selected" : ""
  }, row.company), /*#__PURE__*/React.createElement("td", {
    className: sortKey === "emissions" ? "is-selected" : ""
  }, row.emissions)))));
}
...
if (tableEl) {
  ReactDOM.createRoot(tableEl).render(/*#__PURE__*/React.createElement(App, null));
}
...
function CustomForm({
  ...
  const validate = () => {
    ...
    if (formData.honeypot && String(formData.honeypot).trim() !== "") return {
      honeypot: true
    };
